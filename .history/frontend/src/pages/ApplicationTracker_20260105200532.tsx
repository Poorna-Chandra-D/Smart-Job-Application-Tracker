    ...
    <Box sx={{ minHeight: '100vh', background: '#f8f9fa' }}>
      <Container maxWidth="lg" sx={{ py: 4 }}>
        ...
        <Box sx={{ mb: 4 }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 1 }}>
            <BusinessIcon sx={{ fontSize: 40, color: '#667eea' }} />
            <Typography variant="h3" sx={{ color: '#1a1a1a', fontWeight: 800 }}>
              Job Applications
            </Typography>
          </Box>
        ...
        <Grid container spacing={2} sx={{ mb: 4 }}>
          <Grid item xs={12} sm={6} md={3}>
            <Card sx={{ background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', color: '#fff', borderRadius: '16px' }}>
              <CardContent sx={{ textAlign: 'center' }}>
                <Typography color="inherit" variant="body2" sx={{ opacity: 0.9, mb: 1 }}>
                  Total Applications
                </Typography>
          ...
          <Grid item xs={12} sm={6} md={3}>
            <Card sx={{ background: 'linear-gradient(135deg, #1976d2 0%, #1565c0 100%)', color: '#fff', borderRadius: '16px' }}>
              <CardContent sx={{ textAlign: 'center' }}>
                <Typography color="inherit" variant="body2" sx={{ opacity: 0.9, mb: 1 }}>
                  Applied
                </Typography>
          ...
          <Grid item xs={12} sm={6} md={3}>
            <Card sx={{ background: 'linear-gradient(135deg, #f57c00 0%, #e65100 100%)', color: '#fff', borderRadius: '16px' }}>
              <CardContent sx={{ textAlign: 'center' }}>
                <Typography color="inherit" variant="body2" sx={{ opacity: 0.9, mb: 1 }}>
                  Interviews
                </Typography>
          ...
          <Grid item xs={12} sm={6} md={3}>
            <Card sx={{ background: 'linear-gradient(135deg, #388e3c 0%, #2e7d32 100%)', color: '#fff', borderRadius: '16px' }}>
              <CardContent sx={{ textAlign: 'center' }}>
                <Typography color="inherit" variant="body2" sx={{ opacity: 0.9, mb: 1 }}>
                  Offers
                </Typography>
        ...
        <Box sx={{ display: 'flex', gap: 2, mb: 4, flexWrap: 'wrap' }}>
          ...
          <Button
            ...
            sx={{
              ...
              borderRadius: '12px',
              borderWidth: '2px',
              '&:hover': { background: 'rgba(102, 126, 234, 0.05)', borderWidth: '2px' }
            }}
          >
            Add Application
          </Button>
        ...
        {applications.length === 0 ? (
          <Card sx={{ p: 4, textAlign: 'center', background: '#fff', borderRadius: '16px' }}>
      ...
      <Dialog open={openDialog} onClose={handleClose} maxWidth="sm" fullWidth>
        ...
        <DialogActions sx={{ p: 2 }}>
          ...
          <Button onClick={handleSubmit} variant="contained" sx={{ background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)' }}>
      ...
      <Dialog open={messageDialog} onClose={handleCloseMessageDialog} maxWidth="md" fullWidth>
        <DialogTitle sx={{ background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', color: '#fff', fontWeight: 700, display: 'flex', alignItems: 'center', gap: 1 }}>
          <MailIcon />
          Email Message
        </DialogTitle>
        <DialogContent sx={{ pt: 3, whiteSpace: 'pre-wrap', wordWrap: 'break-word', maxHeight: '60vh', overflow: 'auto', background: '#fafafa' }}>
          <Typography sx={{ fontSize: '0.95rem', lineHeight: 1.7, color: '#333' }}>
            {selectedMessage}
          </Typography>
        </DialogContent>
        <DialogActions sx={{ p: 2 }}>
          <Button onClick={handleCloseMessageDialog} variant="contained" sx={{ background: '#667eea' }}>Close</Button>
        </DialogActions>
      </Dialog>
    </Box>
  );
